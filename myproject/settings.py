...
MIDDLEWARE = [
    ...
    "whitenoise.middleware.WhiteNoiseMiddleware",  # Serves static files in DEBUG=False
...
STORAGES = {
    ...
    "staticfiles": {
        # WhiteNoise: serves static files in DEBUG=False, adds cache-busting fingerprints
